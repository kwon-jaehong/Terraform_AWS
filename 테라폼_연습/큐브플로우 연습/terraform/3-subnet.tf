...
resource "aws_subnet" "test_eks_public_1" {
...
resource "aws_subnet" "test_eks_public_2" {
  vpc_id = aws_vpc.test_eks_vpc.id
...
resource "aws_subnet" "test_eks_private_1" {
  vpc_id = aws_vpc.test_eks_vpc.id
...
resource "aws_subnet" "test_eks_private_2" {
  vpc_id = aws_vpc.test_eks_vpc.id
